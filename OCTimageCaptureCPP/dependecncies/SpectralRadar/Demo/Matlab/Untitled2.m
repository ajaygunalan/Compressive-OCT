...
folderPath = 'data/sample3'; 
fileName = 'oct2.jpg';
savedImageFullPath = fullfile(folderPath, fileName);
...
folderPath = 'data/sample3'; 
fileName = 'scanPattern2.jpg';
savedImageFullPath = fullfile(folderPath, fileName);
VideoImage1 = imread(savedImageFullPath);
...
scalingFactor = distRGB/(pts(end)-pts(1)) ;
...
for i = 1:numel(pts)
    ...
    newPoint = plotPoints(1,:) + displacement;
...
% Define a new colormap from light blue to dark blue
newColormap = [linspace(0.6784, 0, 100)', linspace(0.8471, 0, 100)', linspace(0.9020, 1, 100)'];
