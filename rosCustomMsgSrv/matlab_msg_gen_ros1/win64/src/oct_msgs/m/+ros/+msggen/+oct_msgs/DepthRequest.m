...
classdef DepthRequest < ros.Message
    %DepthRequest MATLAB implementation of oct_msgs/DepthRequest
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.
    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'oct_msgs/DepthRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.oct_msgs.DepthRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.oct_msgs.DepthRequest(strObj);
        end
    end
end
