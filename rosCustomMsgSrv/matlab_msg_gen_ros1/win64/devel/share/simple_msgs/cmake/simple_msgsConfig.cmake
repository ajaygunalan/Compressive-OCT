...
if("TRUE" STREQUAL "TRUE")
  set(simple_msgs_SOURCE_PREFIX C:/Ajay_OCT/OCT-Guided-AutoCALM/rosCustomMsgSrv/matlab_msg_gen_ros1/win64/src/simple_msgs)
  set(simple_msgs_DEVEL_PREFIX C:/Ajay_OCT/OCT-Guided-AutoCALM/rosCustomMsgSrv/matlab_msg_gen_ros1/win64/devel)
  ...
  set(simple_msgs_INSTALL_PREFIX C:/Ajay_OCT/OCT-Guided-AutoCALM/rosCustomMsgSrv/matlab_msg_gen_ros1/win64/install)
...
if(NOT "C:/Ajay_OCT/OCT-Guided-AutoCALM/rosCustomMsgSrv/matlab_msg_gen_ros1/win64/devel/include;C:/Ajay_OCT/OCT-Guided-AutoCALM/rosCustomMsgSrv/matlab_msg_gen_ros1/win64/src/simple_msgs/include " STREQUAL " ")
  set(simple_msgs_INCLUDE_DIRS "")
  set(_include_dirs "C:/Ajay_OCT/OCT-Guided-AutoCALM/rosCustomMsgSrv/matlab_msg_gen_ros1/win64/devel/include;C:/Ajay_OCT/OCT-Guided-AutoCALM/rosCustomMsgSrv/matlab_msg_gen_ros1/win64/src/simple_msgs/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/Ajay_OCT/OCT-Guided-AutoCALM/rosCustomMsgSrv/matlab_msg_gen_ros1/win64/src/simple_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT simple_msgs_NUM_DUMMY_TARGETS)
      set(simple_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::simple_msgs::wrapped-linker-option${simple_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR simple_msgs_NUM_DUMMY_TARGETS "${simple_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::simple_msgs::wrapped-linker-option${simple_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND simple_msgs_LIBRARIES "${interface_target_name}")
...
set(simple_msgs_EXPORTED_TARGETS "simple_msgs_generate_messages_cpp;simple_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(simple_msgs_EXPORTED_TARGETS ${${simple_msgs_dep}_EXPORTED_TARGETS})
endforeach()
